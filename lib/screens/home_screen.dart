      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _bulletPoint('Exemption certificates for individuals are valid for two (2) years from date of issue or renewal.'),
            _bulletPoint('Processing time is 3 to 5 working days.'),
            _bulletPoint('Applications must be submitted in writing to the Minister of Home Affairs.'),
          ],
        ),
      ),
    );
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'MOTOR VEHICLES AND ROAD TRAFFIC (TINT) REGULATIONS 2026',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.blue),
            ),
            const SizedBox(height: 12),
            const Text(
              'Made under the Motor Vehicles and Road Traffic Act (Cap. 51:02)',
            ...
            const SizedBox(height: 12),
            const Text(
              'NEW VEHICLE TINT RULES TAKE EFFECT: MARCH 31, 2026',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.red),
            ),
            const SizedBox(height: 8),
            const Text(
              'The Motor Vehicles and Road Traffic (Tint) Regulations 2026 is aimed to improve safety and fair enforcement across Guyana.',
            ...
            const SizedBox(height: 8),
            _bulletPoint('Front windscreen: No tint permitted (Nil VLT).'),
            ...
            Container(
              ...
              child: const Text(
                '⚠️ IMPORTANT: All mirrored, metallic, or reflective window tints are illegal under the new regulations.',
            ...
            _bulletPoint('Visors on front windscreen shall not extend more than 6 inches (windscreen < 3 feet) or 10 inches (windscreen ≥ 3 feet) from the top.'),
            _bulletPoint('Visor VLT must be at least 25%.'),
            const SizedBox(height: 8),
            const Text(
              'MARGIN OF DIFFERENCE:',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11),
            ),
            _bulletPoint('Tint readings are deemed compliant if within ±3% of the prescribed VLT level.'),
            const SizedBox(height: 12),
            const Text(
              'ENFORCEMENT:',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12),
            ...
            const SizedBox(height: 8),
            _bulletPoint('The Commissioner of Police shall authorise trained police officers to conduct tint inspections using approved tint meters.'),
            _bulletPoint('Tint meters are certified by the Guyana National Bureau of Standards and must be calibrated and maintained according to prescribed standards.'),
            _bulletPoint('Tint readings obtained by authorised officers using approved tint meters are admissible as evidence in court proceedings.'),
            const SizedBox(height: 12),
            const Text(
            ...
            const SizedBox(height: 8),
            _bulletPoint('Offences involving illegal tint will attract a fine of \$30,000 (Guyana Dollars) for drivers and businesses applying unlawful tint.'),
            _bulletPoint('This includes vehicle operators and businesses involved in applying tint contrary to regulation 3.'),
            _bulletPoint('Failure to produce an exemption certificate when requested by an authorised officer also attracts a fine of \$30,000.'),
            const SizedBox(height: 12),
            const Text(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            _bulletPoint('Vehicles used by the President and Prime Minister (in official or personal capacity).'),
            _bulletPoint('Designated senior government officials (as designated by the Minister).'),
            _bulletPoint('The Police Force, Defence Force, Fire Service, Prison Service, and Customs Anti-Narcotics Unit.'),
            _bulletPoint('Registered ambulances.'),
            _bulletPoint('Diplomatic and consular missions.'),
            _bulletPoint('Licensed private security agencies (within the meaning of section 2 of the Private Security Services Act).'),
            _bulletPoint('Individuals with certified medical conditions requiring reduced exposure to sunlight (see list below).'),
            _bulletPoint('Persons or businesses engaged in high-risk cash handling or security-sensitive operations.'),
            const SizedBox(height: 12),
            const Text(
            ...
            const SizedBox(height: 8),
            _bulletPoint('Applications for exemptions must be submitted in writing to the Minister of Home Affairs.'),
            _bulletPoint('The Minister will consider the application and may issue or refuse to issue an exemption certificate.'),
            _bulletPoint('For exemptions based on medical grounds, applications must be accompanied by a certificate from a registered medical practitioner confirming the medical condition and specifying the expected duration.'),
            _bulletPoint('All approved exemptions will be recorded in the digital national tint registry maintained by the Ministry of Home Affairs.'),
            const SizedBox(height: 12),
            const Text(
            ...
            const SizedBox(height: 8),
            _bulletPoint('Albinism'),
            _bulletPoint('Systemic lupus erythematosus (lupus)'),
            _bulletPoint('Xeroderma pigmentosum'),
            _bulletPoint('Photosensitive epilepsy'),
            _bulletPoint('Chronic photodermatitis or solar urticaria'),
            _bulletPoint('Severe dermatomyositis'),
            _bulletPoint('Porphyria cutanea tarda'),
            _bulletPoint('Any other condition certified by a medical practitioner as causing abnormal sensitivity to sunlight'),
            const SizedBox(height: 12),
            Container(
              padding: const EdgeInsets.all(8),
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Approved exemption certificates must be kept in the vehicle at all times and produced upon request by an authorised officer.',
                    style: TextStyle(fontSize: 10),
                  ),
                  const SizedBox(height: 4),
                  const Text(
                    'Validity: Exemption certificates for individuals are valid for 2 years from date of issue or renewal. Certificates for public bodies are valid as determined by the Minister.',
                    style: TextStyle(fontSize: 10, fontStyle: FontStyle.italic),
                  ),
                  const SizedBox(height: 4),
                  const Text(
                    'Note: Exemptions become void upon sale/transfer of vehicle, vehicle destruction, or death of the person specified.',
                    style: TextStyle(fontSize: 10, fontStyle: FontStyle.italic),
                  ),
                ],
              ),
